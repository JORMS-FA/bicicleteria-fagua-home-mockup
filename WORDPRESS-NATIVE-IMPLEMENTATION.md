...
En las fichas, la disponibilidad positiva se deriva del stock real de WooCommerce; los productos agotados conservan el aviso nativo y ahora lo exponen con `role="status"` para lectores de pantalla. Los productos `onbackorder` se distinguen como “Disponible bajo pedido” en lugar de prometer disponibilidad inmediata, aunque WooCommerce todavía añade su aviso nativo “Disponible para reserva”; queda pendiente armonizar ambos avisos para evitar duplicación o confusión. No se publican cantidades inventadas.
