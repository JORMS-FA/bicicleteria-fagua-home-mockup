...
El archivo de Tienda mantiene el catálogo dinámico de WooCommerce, ahora con una introducción comercial nativa (promesa y CTA de asesoría), barra lateral nativa de categorías y precio, tarjetas estilizadas desde Blocksy y objetivos táctiles móviles de 44 px. El MU-plugin `fagua-mobile-shop-filters.php` añade en móvil filtros dinámicos de categoría, rango de precio y disponibilidad; en escritorio permanece oculto para conservar el sidebar nativo. El rango activo se repuebla al reabrir el panel, el selector de orden y “Limpiar filtros” conservan áreas táctiles de 44 px y el mini-carrito expone su control de quitar en español. La imagen destacada de la Falcon (adjunto 647) ya tiene texto alternativo completo. La ficha “Cadenilla Shimano CN-HG40” usa un slug coherente y el anterior CN-HG93 conserva una redirección 301 explícita que mantiene parámetros de WooCommerce. La página duplicada “Nosotros y contacto” y el agregado antiguo “Políticas y condiciones” se conservaron como borradores reversibles; “Nosotros”, “Contacto” y las páginas legales individuales quedan como páginas canónicas.
